insert into store_category (id, name, featured_product_id)
...
insert into store_product (id, title, description, unit_price, inventory, last_update, category_id, slug)
